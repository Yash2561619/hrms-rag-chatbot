...
Webhook server using PostgreSQL + pgvector, FastEmbed, and Gemini API for RAG & HR operations.
"""
...
from app.services.rag_service import handle_rag_query, load_indexes
...
def router(employee, message):
    ...
    logger.info(
        "ROUTER_RECEIVED | user=%s | message=%s",
